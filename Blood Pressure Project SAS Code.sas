dm log 'clear' log;
dm output 'clear' log; /* clears the log and the output so that the code can keep running */
...
*adding underscores to variable names;
...
proc sgplot data= sleep_a;
    vbar Sleep_Disorder / group= High_BP
...
run;
/*age, heart_rate, and quality_of_sleep are strongly correlated to BP. P value < .001*/

/*testing correlation between systolic BP and age*/
